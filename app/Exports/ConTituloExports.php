...
class ConTituloExports implements FromView,WithCustomStartCell,WithHeadings
{
    /**
    ...
    */
    public function data()
    {
        ...
        ->where("estMat",1) ->where("estOff",1) ->where("estPee",1)->whereNotNull("idTit")
        ->where("estAlu",1)->orderBy("a.idAlu","ASC")->groupBy("idTit")->get();
    }
