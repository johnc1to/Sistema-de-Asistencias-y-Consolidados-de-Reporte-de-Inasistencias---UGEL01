<form id="formulario01" enctype="multipart/form-data" class="form-horizontal calender" method="post" role="form" onsubmit="guardar_soporte();return false;">          
    <div class="modal-header">
        <h4 class="modal-title" id="myModalLabel" style="text-align:center;"><b>RESTABLECER ACCESO DOCENTE</b></h4>      
    </div>
    <div class="modal-body">

    <div id="testmodal" style="padding: 5px 20px;">
    <input name="idTip" value="1" type="hidden">
    <input name="codmodSop" value="" type="hidden">
    <input name="id_contactoSop" value="" type="hidden">
    <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12"> <input type="radio" name="docbox" checked> <b>Registro unico</b> &nbsp;&nbsp;&nbsp; <input type="radio" name="docbox" onclick="masivorestableceraccesodocente();"> <b>Registro masivo</b> <br><br> </div>
    ...
    <div class="row">
        <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4"><b>CUENTA<br>@APRENDOENCASA:</b></div>
        <div class="col-xs-12 col-sm-8 col-md-8 col-lg-8"><input type="text" autocomplete="off" value="" name="cueSop" class="inputdatos form-control" required></div>
    </div>
