...
<div class="container d-flex justify-content-center ">
    <div class="text-center col-md-12">
        <h1 class="display-4 mb-3">Lista de asistencia de personal en teletrabajo</h1>
        @isset($teletrabajo)
        @foreach ($teletrabajo as $item)
        @if(isset($item->personalteletrabajo) && $item->personalteletrabajo != null)
            <button class="btn btn-primary btn-lg px-5 py-3" id="btn_marcar_asistencia" style="font-size: 1rem;">
                INGRESAR A SALA DE TELETRABAJO
            </button>
            @break;
...
<script>
    ...
    $(document).ready(function () {
       let table =  $('#tabla_asistencia').DataTable({
            ...
            ajax: {
                url: '{{route("data-monitoreo-asistencia")}}', // Aqui solo llamo al formulario. Esta web no inserta nada.
                type: "GET",
            ...
            columnDefs: [
                {
                    ...
                    "targets": 6 // Cambia el índice de la columna según tu tabla
                },
                {
                    "targets": 0,
                    "searchable": false,
            ...
            order: [[7, 'desc']], // Ordenar por la primera columna (ID) de forma descendente
