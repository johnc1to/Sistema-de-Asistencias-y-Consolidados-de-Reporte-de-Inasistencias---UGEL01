    ...
    <div class="table-responsive-xl">
        ...
        <thead>
            <tr>
                ...
                <th colspan="4" class="text-center">Información del Título</th>
    ...
    <script>
            ...
            'click .ver_titulo': function (e) {
                ...
                $.ajax({
                    ...
                    success: function(data){
                        ...
                        $("#numeracionUgel .modal-body").html(data);
                        $("#saveNumeracionModel .ver_titulo1").attr("id",idTit)
                        $("#saveNumeracionModel #form-numeracion #titulo_id").val(idTit)
                    }
                  });
        ...
        /* function initTable() {
          ...
          function actionFormatter(e,row)
          {
            ...
            {
                return e
            }else if(row.situacion==2){
                return `<a class='btn btn-outline-success ver_titulo'  id='${row.idTit}' href="#" data-bs-toggle="modal" data-bs-target="#numeracionUgel">${e}</a>`;
