  ...
  <link rel="stylesheet" href="https://unpkg.com/leaflet@1.9.4/dist/leaflet.css" />
    ...
    <div class="mt-4">
        ...
        <div id="tablaReporte" class="w-full max-w-full mx-auto bg-white rounded-xl shadow-md p-6 mt-10 block">
            <h1 class="text-2xl font-bold text-center mb-4 uppercase">Reporte de Cumplimiento del Anexo 03</h1>
...
<script>
    ...
    document.addEventListener("DOMContentLoaded", function () {
        ...
        function activarTab(botonActivo, tablaActiva) {
            [tablaReporte, tablaObservaciones, tablaBloque].forEach(t => t.classList.add("hidden"));
            [btnReporte, btnObservaciones, btnBloque].forEach(b => {
