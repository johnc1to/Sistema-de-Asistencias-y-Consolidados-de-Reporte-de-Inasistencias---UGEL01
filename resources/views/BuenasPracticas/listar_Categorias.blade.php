...
<div class="main-card mb-12 card">
    <div class="card-body"><h5 class="card-title" style="font-size:20px;"><b>Categoria</b> <a target="_blank" class="btn btn-info" href="https://buenaspracticas.ugel01.gob.pe/">Ver en Pagina Web</a>
    </h5>
        <div class="position-relative form-group">
            
        <form id="formulario" onsubmit="grabar_Categorias();return false;">
            <div class="row">
                <div class="col-sm-4">idCategoria:</div>
                <div class="col-sm-8"><input type="text" class="form-control" name="idCategoria" id="idCategoria" readonly></div>

                <div class="col-sm-4">Titulo:</div>
                <div class="col-sm-8"><input type="text" class="form-control" name="titulo" id="titulo"></div>
                 
                <div class="col-sm-4">Descripcion:</div>
                <div class="col-sm-8"><input type="text" class="form-control" name="descripcion" id="descripcion"></div>

                <div class="col-sm-4">Imagen:</div>
                <div class="col-sm-8"><input type="file" class="form-control" name="imagen" id="imagen"></div>
            ...
            <table class="display table table-bordered table-striped table-dark" id="t_programas" style="color:#000;font-size:10px;width:100%;">
                          <thead>
                            <tr style="background-color:rgb(0,117,184);">
                                ...
                                <td style="width:45px;color:#fff;"><b>Descripcion</b></td>
                                <td style="width:45px;color:#fff;"><b>Imagen</b></td>
                            </tr>
                          </thead>
                          <tbody></tbody>
                        </table>
...
function grabar_Categorias(id='formulario'){
          var formData = new FormData($("#"+id)[0]);
          var message = "";
          $.ajax({
              url: "{{route('guardar_Categorias')}}",  
              type: 'POST',
              data: formData,
              dataType: "json",
              cache: false,
    ...
    $.ajax({
                    ...
                    success: function(data){
                          for (let i = 0; i < data.length; i++) {
                            ...
                            data[i]['eliminar']='<span class="btn btn-danger" onclick="eliminar_Categorias('+data[i]['idCategoria']+')">eliminar</span>';
                          }
                          table4.clear().draw();
...
function eliminar_Categorias(idCategoria){
    ajax_data = {
