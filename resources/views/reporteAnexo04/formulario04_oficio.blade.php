...
<body>
    ...
    <div class="mb-6 flex items-start">
        ...
        <div class="text-justify flex-1">
            <span class="font-bold">
                ENVÍO DEL ANEXO 04 FORMATO 02: REPORTE CONSOLIDADO DE INASISTENCIAS, TARDANZAS Y PERMISOS SIN GOCE DE REMUNERACION CORRESPONDIENTE AL MES DE 
    ...
    <div class="text-justify indent mb-4">
        Tengo el agrado de dirigirme a usted expresándole mi cordial saludo, asimismo, para informarle sobre el envío a su despacho del <span class="font-bold uppercase">ANEXO 04 FORMATO 02: REPORTE CONSOLIDADO DE INASISTENCIAS, TARDANZAS Y PERMISOS SIN GOCE DE REMUNERACIÓN CORRESPONDIENTE AL <span class="subrayado">MES DE {{ \Carbon\Carbon::create($anio, $mes, 1)->locale('es')->isoFormat('MMMM [] YYYY') }}</span> DE LA IE “{{ strtoupper($institucion) }}”.</span>
    </div>
