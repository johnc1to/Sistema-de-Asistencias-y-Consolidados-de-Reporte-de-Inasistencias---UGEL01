    ...
    */
    ...
    'connections' => [
        ...
        'bienes' => [
            'driver' => 'mysql',
            'url' => env('DATABASE_URL'),
            'host' => env('DB_HOST_BIENES', '127.0.0.1'),
            'port' => env('DB_PORT_BIENES', '3306'),
            'database' => env('DB_DATABASE_BIENES', 'forge'),
            'username' => env('DB_USERNAME_BIENES', 'forge'),
            'password' => env('DB_PASSWORD_BIENES', ''),
            'unix_socket' => env('DB_SOCKET_BIENES', ''),
            'charset' => 'utf8mb4',
            'collation' => 'utf8mb4_unicode_ci',
            'prefix' => '',
            'prefix_indexes' => true,
        ...
        'siguhs' => [
            'driver' => 'mysql',
            'url' => env('DATABASE_URL'),
            'host' => env('DB_HOST_SIGUHS', '127.0.0.1'),
            'port' => env('DB_PORT_SIGUHS', '3306'),
            'database' => env('DB_DATABASE_SIGUHS', 'forge'),
            'username' => env('DB_USERNAME_SIGUHS', 'forge'),
            'password' => env('DB_PASSWORD_SIGUHS', ''),
            'unix_socket' => env('DB_SOCKET_SIGUHS', ''),
            'charset' => 'utf8mb4',
            'collation' => 'utf8mb4_unicode_ci',
            'prefix' => '',
            'prefix_indexes' => true,
        ...
        'sicab1' => [
            'driver' => 'mysql',
            'url' => env('DATABASE_URL'),
            'host' => env('DB_HOST_SICAB1', '127.0.0.1'),
            'port' => env('DB_PORT_SICAB1', '3306'),
            'database' => env('DB_DATABASE_SICAB1', 'forge'),
            'username' => env('DB_USERNAME_SICAB1', 'forge'),
            'password' => env('DB_PASSWORD_SICAB1', ''),
            'unix_socket' => env('DB_SOCKET_SICAB1', ''),
            'charset' => 'utf8mb4',
            'collation' => 'utf8mb4_unicode_ci',
            'prefix' => '',
            'prefix_indexes' => true,
        ...
        'siic_anexos' => [
            ...
            'database' => env('DB_DATABASE12', 'siic01ugel01gob_anexos'),
